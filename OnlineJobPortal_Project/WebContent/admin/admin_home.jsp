	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="../home_login.jsp" class="nav-link">Home</a></li>
	           <li class="nav-item active"><a href="view_Jobseekers.jsp" class="nav-link">View Seekers</a></li>
	          <li class="nav-item active"><a href="view_jobproviders.jsp" class="nav-link">View Providers</a></li>
