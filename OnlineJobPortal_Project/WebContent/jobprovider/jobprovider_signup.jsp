...
<head>
    ...
    <!-- Title Page-->
    <title>job provider sign up page</title>
...
<body>
<%String jobprovider_id= (String)session.getAttribute("jobprovider_id"); 
    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">job provider sign-up</h2>
                    <form method="POST" action="user_insert.jsp">
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">your id is</label>
                                    <input class="input--style-4" type="text" name="id" value='<%=jobprovider_id %>'>
                                </div>
                            </div>
                           <div><%= message %></div>
                        </div>
